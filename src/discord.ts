import { Guild, User, ReadyPacket, ChatMessage, PrivateChannel, ChannelUpdate, PresenceUpdate, Authenticator, TypingStart, Relationship } from "./types.ts";
...
type DiscordEvents = {
    'ready': [], 'close': [ reason: string ],
    'resumed': [], 'heartbeat': [], 'heartbeat_ack': [],

    'auth_change': [d: { auth_session_id_hash: string }],
    'auth_create': [d: Authenticator],
    'auth_update': [d: Authenticator],
    'auth_delete': [d: { id: string, type: number }],
    'app_command_perm': [], 'automod_raid_mention': [], 'call_create': [], 'call_update': [], 'call_delete': [],
    'channel_create': [], 'channel_update': [channel: ChannelUpdate], 'channel_delete': [], 'channel_statuses': [],
    'voice_channel_update': [], 'channel_pins_update': [], 'group_add_member': [], 'group_remove_member': [], 'dm_settings_upsell': [],
    ...
    'guild_scheduled_ev_create': [], 'guild_scheduled_ev_update': [], 'guild_scheduled_ev_delete': [], 'guild_scheduled_ev_add_user': [],
    'guild_scheduled_ev_rem_user': [], 'guild_soundboard_audio_create': [], 'guild_audio_update': [], 'guild_audio_delete': [], 'soundboard_sounds': [],
    ...
    'oauth2_token_revoke': [], 'presence_update': [presence: PresenceUpdate], 'relationship_add': [], 'relationship_update': [],
    'relationship_remove': [], 'stage_instance_create': [], 'stage_instance_update': [], 'stage_instance_delete': [],
    'typing_start': [d: unknown], 'user_update': [], 'user_app_remove': [], 'user_conn_update': [], 'user_note_update': [],
    'user_req_action_update': [], 'voice_state_update': [], 'voice_server_update': [], 'voice_channel_effect_send': [],
    'webhooks_update': [],
};
...
export class DiscordController extends TypedEventEmitter<DiscordEvents> {
    ...
    protected onClose(ev: CloseEvent) {
        this.logHandler(`Client closed with reason "${ev.reason}"`);
    ...
    onMessage(ev: MessageEvent<any>) {
        ...
        switch (p.op) {
            case DiscordPackets.InitHeartbeat: {
                ...
                this.ws.send(JSON.stringify({
                    ...
                    d: {
                        ...
                        properties: {
                            os: "Linux",
                            browser: "Chrome", // I'm a linux chrome environment, i swear!
                            device: "",
                            system_locale: "en-US",
            ...
            case DiscordPackets.HeartbeatAck:
            ...
            case DiscordPackets.User:
                switch (p.t) {
                    ...
                    case 'TYPING_START':    this.emit('typing_start',       p.d as TypingStart); break;
